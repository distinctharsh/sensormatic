            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="solution-card text-center">
                        <img src="/images/c.jpg" alt="Loss Prevention" class="img-fluid rounded mb-3" style="height: 200px; object-fit: cover; width: 100%;">
                ...
                <div class="col-md-4 mb-4">
                    <div class="solution-card text-center">
                        <img src="/images/c.jpg" alt="Inventory Intelligence" class="img-fluid rounded mb-3" style="height: 200px; object-fit: cover; width: 100%;">
                ...
                <div class="col-md-4 mb-4">
                    <div class="solution-card text-center">
                        <img src="/images/c.jpg" alt="Traffic Insights" class="img-fluid rounded mb-3" style="height: 200px; object-fit: cover; width: 100%;">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="featured-content">
                        <img src="/images/c.jpg" alt="Getting Started With Source Tagging" class="img-fluid rounded mb-3">
                ...
                <div class="col-md-6 mb-4">
                    <div class="featured-content">
                        <img src="/images/c.jpg" alt="A New Vision for Retail" class="img-fluid rounded mb-3">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <img src="/images/c.jpg" alt="Innovation Experience" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                @forelse($featuredResources->where('type', 'Case Study')->take(2) as $resource)
                    <div class="col-md-6 mb-4">
                        <div class="case-study-card">
                            <img src="/images/c.jpg" alt="{{ $resource->title }}" class="img-fluid rounded mb-3" style="height: 250px; object-fit: cover; width: 100%;">
                ...
                @empty
                    <div class="col-md-6 mb-4">
                        <div class="case-study-card">
                            <img src="/images/c.jpg" alt="Case Study" class="img-fluid rounded mb-3" style="height: 250px; object-fit: cover; width: 100%;">
                            <div class="case-study-content">
